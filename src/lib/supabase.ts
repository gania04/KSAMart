...
const SUPABASE_URL = ((import.meta as any).env?.VITE_SUPABASE_URL as string) || 'https://svfbkndqyvcqglqjvrql.supabase.co';
const SUPABASE_ANON_KEY = ((import.meta as any).env?.VITE_SUPABASE_ANON_KEY as string) || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN2ZmJrbmRxeXZjcWdscWp2cnFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODMzMjE3MjgsImV4cCI6MjA5ODg5NzcyOH0.pdHoURRMkE-cLCg44CTfH_MJlpYhsPSmJDPnhQ928nk';
