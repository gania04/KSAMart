...
| Key | Value |
|-----|-------|
| `VITE_SUPABASE_URL` | `https://svfbkndqyvcqglqjvrql.supabase.co` |
| `VITE_SUPABASE_ANON_KEY` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN2ZmJrbmRxeXZjcWdscWp2cnFsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODMzMjE3MjgsImV4cCI6MjA5ODg5NzcyOH0.pdHoURRMkE-cLCg44CTfH_MJlpYhsPSmJDPnhQ928nk` |
...
*KSA Mart Syariah — KSADZZIKRA | Supabase: svfbkndqyvcqglqjvrql*
